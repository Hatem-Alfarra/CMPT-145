...
def copy_list_of_lists(data: list) -> list:
    ...
    # reference. The slice operator [:] creates a new list containing all the elements from the original list which
    # would fix the nested lists' problem.

    # Old code snippet commented below
    # new_list = data
...
def remove_from_2DList(data:list, val) -> list:
    ...
    # list. while val is in the sub-list the value val is removed using the method remove().
